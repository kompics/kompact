...
{{#rustdoc_include ../../examples/local/src/batching.rs}}
```
...
```rust,edition2018,no_run,noplaypen
{{#rustdoc_include ../../examples/local/src/bin/buncher_regular.rs:main}}
```
...
```rust,edition2018,no_run,noplaypen
{{#rustdoc_include ../../examples/local/src/bin/buncher_regular.rs:state}}
```
...
```rust,edition2018,no_run,noplaypen
{{#rustdoc_include ../../examples/local/src/bin/buncher_regular.rs:lifecycle}}
```
...
```rust,edition2018,no_run,noplaypen
{{#rustdoc_include ../../examples/local/src/bin/buncher_regular.rs:private_functions}}
```
...
```rust,edition2018,no_run,noplaypen
{{#rustdoc_include ../../examples/local/src/bin/buncher_regular.rs:batching_port}}
```
...
```bash
Mar 10 15:42:03.734 INFO Got a batch with 100 Pings., ctype: BatchPrinter, cid: 4c79e0b1-1d74-455b-987a-14f66bcd4025, system: kompact-runtime-1, location: docs/examples/local/src/batching.rs:33
Mar 10 15:42:03.762 INFO Got a batch with 22 Pings., ctype: BatchPrinter, cid: 4c79e0b1-1d74-455b-987a-14f66bcd4025, system: kompact-runtime-1, location: docs/examples/local/src/batching.rs:33
Mar 10 15:42:03.890 INFO Got a batch with 100 Pings., ctype: BatchPrinter, cid: 4c79e0b1-1d74-455b-987a-14f66bcd4025, system: kompact-runtime-1, location: docs/examples/local/src/batching.rs:33
Mar 10 15:42:03.912 INFO Got a batch with 16 Pings., ctype: BatchPrinter, cid: 4c79e0b1-1d74-455b-987a-14f66bcd4025, system: kompact-runtime-1, location: docs/examples/local/src/batching.rs:33
```
...
```rust,edition2018,no_run,noplaypen
{{#rustdoc_include ../../examples/local/src/bin/buncher_adaptive.rs:lifecycle}}
```
...
```rust,edition2018,no_run,noplaypen
{{#rustdoc_include ../../examples/local/src/bin/buncher_adaptive.rs:handle_timeout}}
```
...
```rust,edition2018,no_run,noplaypen
{{#rustdoc_include ../../examples/local/src/bin/buncher_adaptive.rs:batching_port}}
```
