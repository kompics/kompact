...
{{#rustdoc_include ../../../examples/local/src/bin/workers.rs:work_result}}
```
...
```rust,edition2018,no_run,noplaypen
{{#rustdoc_include ../../../examples/local/src/bin/workers.rs:work}}
```
...
```rust,edition2018,no_run,noplaypen
{{#rustdoc_include ../../../examples/local/src/bin/workers.rs:work_part}}
```
...
```rust,edition2018,no_run,noplaypen
{{#rustdoc_include ../../../examples/local/src/bin/workers.rs:worker_port}}
```
