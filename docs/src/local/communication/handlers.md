...
{{#rustdoc_include ../../../examples/local/src/bin/workers.rs:worker_actor}}
```
...
```rust,edition2018,no_run,noplaypen
{{#rustdoc_include ../../../examples/local/src/bin/workers.rs:worker_ports}}
```
...
```rust,edition2018,no_run,noplaypen
{{#rustdoc_include ../../../examples/local/src/bin/workers.rs:manager_lifecycle}}
```
